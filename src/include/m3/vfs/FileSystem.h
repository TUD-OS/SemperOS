...
public:
    ...
    /**
     * Rename a file given by <oldpath> to <newpath>
     *
     * @param oldpath the existing file to be renamed
     * @param newpath the destined new path
     * @return the error, if any happened
     */
    virtual Errors::Code rename(const char *oldpath, const char *newpath) = 0;
